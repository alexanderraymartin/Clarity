...
public class MainMenu extends State {
  ...
  private static final String SETTINGS_FILE_NAME = "setting.png";
  private static final String LOAD_FILE_NAME = "load.png";
  ...
  private MenuItem Settings = new MenuItem(SETTINGS_FILE_NAME, Game.WIDTH/2 - 50, 160);
  private MenuItem Load = new MenuItem(LOAD_FILE_NAME, Game.WIDTH/2 - 50, 115);
  /**
