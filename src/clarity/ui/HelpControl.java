...
public class HelpControl extends State {
  ...
  private static final String BACKGROUND_FILE_NAME = "helpControls" + ".png";
   ...
   */
  public HelpControl(StateManager manager) {
  ...
  public void update() {
    if (EXIT.covered() && Mouse.getMouse().buttonClickAndRelease()) {
      Game.exitGame();
    } else if (GOAL.covered() && Mouse.getMouse().buttonClickAndRelease()) {
